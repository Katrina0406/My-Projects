    ...
    func setupDiverCharacter() {
        ...
        Entity.loadModelAsync(named: "face-down")
            .sink(receiveValue: { [weak self] face in
                ...
                face.scale = SIMD3(Float(1.5), Float(1.5), Float(1.5))
//                face.transform.rotation = simd_quatf(angle: -.pi/6.2,    /* -45 Degrees */
//                                                      axis: [0,1,0])
//                face.transform.rotation += simd_quatf(angle: -.pi/2,    /* -45 Degrees */
//                                                      axis: [0,0,1])
//                face.position.z -= 1.4
                face.position.z += 2
