...
import com.example.mybatisgen.excel.enums.WriteTypeEnum;
...
import com.example.mybatisgen.excel.util.WorkBookUtil;
import com.example.mybatisgen.excel.util.WriteHandlerUtils;
...
import com.example.mybatisgen.excel.write.metadata.holder.WriteHolder;
...
public class WriteContextImpl implements WriteContext {
    ...
    private void addMergedRegionToCurrentSheet(ExcelWriteHeadProperty excelWriteHeadProperty, int rowIndex) {
        for (com.example.mybatisgen.excel.metadata.CellRange cellRangeModel : excelWriteHeadProperty.headCellRangeList()) {
