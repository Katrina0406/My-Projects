package com.example.mybatisgen.excel.read.metadata;
...
import com.example.mybatisgen.excel.read.listener.ModelBuildEventListener;
...
public class ReadWorkbook extends ReadBasicParameter {
     ...
     * <p>
     * if true , you can use {@link com.example.mybatisgen.excel.annotation.ExcelIgnore} ignore a field.
     * <p>
     * if false , you must use {@link com.example.mybatisgen.excel.annotation.ExcelProperty} to use a filed.
     *
