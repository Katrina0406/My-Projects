...
public class WriteWorkbook extends WriteBasicParameter {
     ...
     */
    @Deprecated
    private com.example.mybatisgen.excel.event.WriteHandler writeHandler;
    ...
    public com.example.mybatisgen.excel.event.WriteHandler getWriteHandler() {
        return writeHandler;
    }

    public void setWriteHandler(com.example.mybatisgen.excel.event.WriteHandler writeHandler) {
