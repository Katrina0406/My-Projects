...
import com.example.mybatisgen.excel.cache.selector.EternalReadCacheSelector;
import com.example.mybatisgen.excel.cache.selector.ReadCacheSelector;
import com.example.mybatisgen.excel.cache.selector.SimpleReadCacheSelector;
...
public class ReadWorkbookHolder extends AbstractReadHolder {
    ...
    /**
     * Select the cache.Default use {@link com.example.mybatisgen.excel.cache.selector.SimpleReadCacheSelector}
     */
    ...
    /**
     * The default is all excel objects.if true , you can use {@link com.example.mybatisgen.excel.annotation.ExcelIgnore} ignore a
     * field. if false , you must use {@link com.example.mybatisgen.excel.annotation.ExcelProperty} to use a filed.
     *
