package com.example.mybatisgen.excel.write.metadata.holder;
...
import com.example.mybatisgen.excel.converters.ConverterKeyBuild;
import com.example.mybatisgen.excel.converters.DefaultConverterLoader;
import com.example.mybatisgen.excel.enums.HeadKindEnum;
import com.example.mybatisgen.excel.event.NotRepeatExecutor;
import com.example.mybatisgen.excel.event.Order;
import com.example.mybatisgen.excel.metadata.AbstractHolder;
import com.example.mybatisgen.excel.metadata.Font;
import com.example.mybatisgen.excel.metadata.Head;
import com.example.mybatisgen.excel.metadata.TableStyle;
import com.example.mybatisgen.excel.metadata.property.LoopMergeProperty;
import com.example.mybatisgen.excel.metadata.property.OnceAbsoluteMergeProperty;
import com.example.mybatisgen.excel.metadata.property.RowHeightProperty;
import com.example.mybatisgen.excel.util.CollectionUtils;
import com.example.mybatisgen.excel.write.handler.CellWriteHandler;
import com.example.mybatisgen.excel.write.handler.DefaultWriteHandlerLoader;
import com.example.mybatisgen.excel.write.handler.RowWriteHandler;
import com.example.mybatisgen.excel.write.handler.SheetWriteHandler;
import com.example.mybatisgen.excel.write.handler.WorkbookWriteHandler;
import com.example.mybatisgen.excel.write.handler.WriteHandler;
import com.example.mybatisgen.excel.write.merge.LoopMergeStrategy;
import com.example.mybatisgen.excel.write.merge.OnceAbsoluteMergeStrategy;
import com.example.mybatisgen.excel.write.metadata.WriteBasicParameter;
...
import com.example.mybatisgen.excel.write.metadata.style.WriteCellStyle;
import com.example.mybatisgen.excel.write.metadata.style.WriteFont;
import com.example.mybatisgen.excel.write.property.ExcelWriteHeadProperty;
import com.example.mybatisgen.excel.write.style.AbstractVerticalCellStyleStrategy;
import com.example.mybatisgen.excel.write.style.HorizontalCellStyleStrategy;
import com.example.mybatisgen.excel.write.style.column.AbstractHeadColumnWidthStyleStrategy;
import com.example.mybatisgen.excel.write.style.row.SimpleRowHeightStyleStrategy;
    ...
    private void compatibleOldCodeCreateRowCellStyleStrategy(WriteBasicParameter writeBasicParameter,
        ...
        writeBasicParameter.getCustomWriteHandlerList()
                .add(new HorizontalCellStyleStrategy(
                        buildWriteCellStyle((Font) tableStyle.getTableHeadFont(), tableStyle.getTableHeadBackGroundColor()),
                        buildWriteCellStyle((Font) tableStyle.getTableContentFont(), tableStyle.getTableContentBackGroundColor())));
    }
