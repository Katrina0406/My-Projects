package com.example.mybatisgen.excel.annotation;
...
public @interface ExcelProperty {
    ...
    /**
     *
     * default @see com.example.mybatisgen.excel.util.TypeUtil if default is not meet you can set format
     *
     * @return Format string
     * @deprecated please use {@link com.example.mybatisgen.excel.annotation.format.DateTimeFormat}
     */
    @Deprecated
