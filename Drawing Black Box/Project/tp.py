...
class MyApp(App):
	...
	def appStarted(self):
		...
		self.img2 = self.loadImage('help.jpg')
		self.img2 = self.scaleImage(self.img2, 0.55)
		# from my own drawing
		self.img3 = self.loadImage('sample.jpg')
		self.img3 = self.scaleImage(self.img3, 0.35)
			...
			for cordi in cont:
				...
				if self.flipH:
					...
					if y > cy:
						...
						y = y + (cy-y)*2
				x1, x2 = x-self.r*self.probX, x+self.r*self.probX
				y1, y2 = y-self.r*self.probY, y+self.r*self.probY
	...
	def mousePressed(self, event):
		if self.splash:
				...
				if self.load != None:
					...
					try:
						if self.load == 'sample':
							...
							self.snap = self.loadImage(self.load)
			...
			# draw clear
				...
				MyApp.cameraParas(self)
				self.draw = True
			elif (720 <= event.x <= 760 and self.height-55 <= event.y <= self.height-35): 
	...
	def drawCameraPage(self, canvas):
		...
		canvas.create_text(self.width/2, 50, text='Scan your drawing and convert!', font='Baloo 42', fill='steel blue')
	...
	def drawHelpboard(self, canvas):
		...
		canvas.create_image(self.width/2, self.height/2, image=ImageTk.PhotoImage(self.img2))
		# canvas.create_rectangle(0, 0, self.width, self.height, fill='SkyBlue1')
		canvas.create_text(self.width/2, 70, text='Help Instruction', font='Baloo 58', fill='dark turquoise')
		canvas.create_text(80, 130, text='* Scan:', font='Baloo 35', fill='dark turquoise', anchor='nw')
		canvas.create_text(240, 130, text='Click "Scan" button,  then click "OK" button to catch a moment', font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 170, text='Use the green frame to select the range,  then click "Convert" to extract contours', font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 210, text='Then click "Convert" to extract contours', font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(80, 270, text='* Upload:', font='Baloo 35', fill='dark turquoise', anchor='nw')
		canvas.create_text(240, 270, text='Click "Upload" to enter the location of your image', font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(80, 330, text='* Draw:', font='Baloo 35', fill='dark turquoise', anchor='nw')
		canvas.create_text(240, 330, text="See the message (yellow color) on the top for each button's function", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 370, text="Click the red circle to clear your drawing", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(80, 430, text='* Output:', font='Baloo 35', fill='dark turquoise', anchor='nw')
		canvas.create_text(240, 430, text="Click the circle on the left of 'Output' button to open the output mode", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 470, text="Then click the 'Output' button to save your drawing on your computer", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(80, 530, text='* Save:', font='Baloo 35', fill='dark turquoise', anchor='nw')
		canvas.create_text(240, 530, text="Click the 'Save' button to save your work on your computer", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 570, text="You can reopen the program later and see your last work", font='Baloo 27', fill='steel blue', anchor='nw')
		canvas.create_text(240, 610, text="Note that contours do not work well for saving function", font='Baloo 27', fill='steel blue', anchor='nw')
	...
	def drawDrawPage(self, canvas):
		...
		if self.retrieve:
			canvas.create_rectangle(720, self.height-55, 760, self.height-35, fill=color2, width=2, outline='gray3')
		if not self.retrieve:
			canvas.create_rectangle(720, self.height-55, 760, self.height-35, fill=color1, width=2, outline='gray3')
		...
		# circles
			...
			canvas.create_text(35, 32, text='Press "Up" to increase contour size or "Down" to decrease.', font='Baloo 32', fill='yellow2', anchor='nw')
