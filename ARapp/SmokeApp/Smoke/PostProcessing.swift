...
//        var fogColor: Color = .init(cgColor: #colorLiteral(red: 0.106, green: 0.467, blue: 0.518, alpha: 1.0))
        var fogColor: Color = .init(cgColor: #colorLiteral(red: 0.3806247711, green: 0.3806936443, blue: 0.3806156516, alpha: 1))

        struct ShaderFloats {
            var fogIntensity: Float = 3.5
            var fogFalloff: Float = 2.2
            var fogExponent: Float = 0.3
            var causticStrength: Float = 0.4
            var causticAddition: Float = 1.0
//            var causticWaveScale: Float = 0.1
//            var causticWaveSpeed: Float = 0.9
            var causticWaveScale: Float = 0
            var causticWaveSpeed: Float = 0
